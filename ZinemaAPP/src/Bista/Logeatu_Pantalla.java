...
public class Logeatu_Pantalla extends JFrame {
	 ...
	 * Create the frame.
	 */
	public Logeatu_Pantalla(Api api) {
		setType(Type.POPUP);
		setResizable(false);
			...
			public void actionPerformed(ActionEvent e) {
				...
				String pasahitza = pswPasahitza.getText();
					...
					if(api.isLoginOk(erabiltzailea, pasahitza)==true) {
						...
						JOptionPane.showMessageDialog(Logeatu_Pantalla.this, "Zure kredentzialak ez dira zuzenak.\nMesedez berriro saiatu.", "Kontuz!", JOptionPane.WARNING_MESSAGE);
					}
