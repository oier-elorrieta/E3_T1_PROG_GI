...
public class Zinema {
	...
	public Zinema(String ordutegia, Saioa[] saioak, String izena, int id, String kokapena) {
	...
	public boolean equals(Object obj) {
		...
		return id == other.id && Objects.equals(izena, other.izena) && Objects.equals(kokapena, other.kokapena)
				&& Objects.equals(ordutegia, other.ordutegia) && Arrays.equals(saioak, other.saioak);
	}
